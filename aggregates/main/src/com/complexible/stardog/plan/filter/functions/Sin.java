...
/**
 * <p>Sine function through R interface</p>
 *
 ...
 *
 */
public final class Sin extends AbstractFunction implements MathFunction {

    protected Sin() {
    	super(1, Namespaces.STARDOG + "sin");
    }
    
    private Sin(final Sin theExpr) {
    	super(theExpr);
    }
