...
/**
 * <p>Tangent function through R interface</p>
 *
 ...
 *
 */
public final class Tan extends AbstractFunction implements MathFunction {

    protected Tan() {
    	super(1, Namespaces.STARDOG + "tan");
    }
    
    private Tan(final Tan theExpr) {
    	super(theExpr);
    }
