...
/**
 * <p>Log function through R interface</p>
 *
 ...
 *
 */
public final class Log extends AbstractFunction implements MathFunction {

    protected Log() {
    	super(1, Namespaces.STARDOG + "log");
    }
    
    private Log(final Log theExpr) {
    	super(theExpr);
    }
