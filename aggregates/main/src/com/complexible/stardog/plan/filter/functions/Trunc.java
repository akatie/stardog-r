 ...
 *
 */
public final class Trunc extends AbstractFunction implements MathFunction {

    protected Trunc() {
    	super(1, Namespaces.STARDOG + "trunc");
    }
    
    private Trunc(final Trunc theExpr) {
    	super(theExpr);
    }
