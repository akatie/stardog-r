...
/**
 * <p>Cosine function through R interface</p>
 *
 ...
 *
 */
public final class Cos extends AbstractFunction implements MathFunction {

    protected Cos() {
    	super(1, Namespaces.STARDOG + "cos");
    }
    
    private Cos(final Cos theExpr) {
    	super(theExpr);
    }
