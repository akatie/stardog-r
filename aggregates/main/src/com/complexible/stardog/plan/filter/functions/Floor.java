 ...
 *
 */
public final class Floor extends AbstractFunction implements MathFunction {

    protected Floor() {
    	super(1, Namespaces.STARDOG + "floor");
    }
    
    private Floor(final Floor theExpr) {
    	super(theExpr);
    }
