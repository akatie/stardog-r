 ...
 *
 */
public final class Log10 extends AbstractFunction implements MathFunction {

    protected Log10() {
    	super(1, Namespaces.STARDOG + "log10");
    }
    
    private Log10(final Log10 theExpr) {
    	super(theExpr);
    }
