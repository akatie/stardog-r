...
/**
 * <p>Signif function through R interface</p>
 *
 ...
 *
 */
public final class Signif extends AbstractFunction implements MathFunction {

    protected Signif() {
    	super(2, Namespaces.STARDOG + "signif");
    }
    
    private Signif(final Signif theExpr) {
    	super(theExpr);
    }
