...
/**
 * <p>Median custom aggregate through the R interface</p>
 *
 * @author  Albert Meroño-Peñuela
 * @since   3.0
 * @version 3.0
 */
public final class Median extends RAggregate {	
	
	public Median() {		
		super(Namespaces.STARDOG + "median");
	}

	protected Median(final Median theAgg) {
		super(theAgg);
	}
	...
	protected Value _getValue() throws ExpressionEvaluationException {
		if (rCurr == null) {
			...
			re.assign("y", y);
			rCurr = null;
			Literal result = literal(re.eval("median(y)").asDouble());
			re.end();
			return result;
		}
	}
